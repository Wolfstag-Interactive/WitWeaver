...
{
    /// <summary>
    /// Defines the contract for reading a spreadsheet file into WitWeaver's internal
    ...
    /// in WitWeaverSettings. At least one language code column is required per sheet.
    ...
    /// </summary>
    public interface IWitWeaverSpreadsheetReader
    {
        /// <summary>
